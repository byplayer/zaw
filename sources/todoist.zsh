...
function zaw-src-todoist-items() {
  ...
  actions=(zaw-src-todoist-items-show zaw-src-todoist-items-close zaw-src-todoist-items-delete)
  act_descriptions=("show" "close" "delete")
  src_opts=(-t "$title")
}

function zaw-src-todoist-items-show () {
  BUFFER="todoist show $1"
  zle accept-line
}

function zaw-src-todoist-items-close () {
  BUFFER="todoist close $1"
  zle accept-line
}

function zaw-src-todoist-items-delete () {
  BUFFER="todoist delete $1"
  zle accept-line
}

zaw-register-src -n todoist-items zaw-src-todoist-items
